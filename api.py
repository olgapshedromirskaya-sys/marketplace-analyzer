...
def find_products(
    ...
    # Демо-карточки: 5 товаров под фильтры (выкуп ≥70%, маржа ≥25%, ROI ≥80%, окупаемость <1 мес, прибыль/шт >50 ₽ при УСН 6%, бюджет 100k–500k)
    return [
        {
